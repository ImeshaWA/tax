...
class _EstimatedTaxPageState extends State<EstimatedTaxPage>
  ...
  void didChangeDependencies() {
    ...
    // Retrieve selectedTaxYear from navigation arguments
    final selectedYear = ModalRoute.of(context)?.settings.arguments as String?;
    if (selectedYear != null) {
      final taxDataService = TaxDataService(); // Singleton instance
      taxDataService.selectedTaxYear = selectedYear; // Update if needed
      print("EstimatedTaxPage initialized with selectedTaxYear: $selectedYear",
      ); // Debug
    }
  }
  ...
  Widget _buildSummaryCard() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: (taxPayable > 0 ? Color(0xFFFF6B35) : primaryColor)
                .withOpacity(0.3),
            blurRadius: 20,
            offset: Offset(0, 10),
          ),
  ...
  Widget build(BuildContext context) {
    ...
    print(
      "Current selectedTaxYear in EstimatedTaxPage: ${taxDataService.selectedTaxYear}",
    ); // Debug
