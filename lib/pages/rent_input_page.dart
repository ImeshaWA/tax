...
Curves.easeOutCubic), 
    ...
    monthlyResidentCtrls = List.generate(12, (_) => 
          ...
          Row( 
            children: [ 
              Container( 
                ...
                child: Icon(Icons.build_rounded, color: Colors.white, size: 
24), 
              ), 
              SizedBox(width: 16), 
              Expanded( 
            ...
            children: [ 
              Expanded( 
                child: GestureDetector( 
                  ...
                  child: AnimatedContainer( 
                    duration: Duration(milliseconds: 200), 
                    padding: EdgeInsets.symmetric(vertical: 16, horizontal: 
20), 
                    decoration: BoxDecoration( 
                      gradient: isMaintainedByUser == true 
                          ? LinearGradient(colors: [primaryColor, 
accentGreen]) 
                          : null, 
                      ...
                      children: [ 
                        Container( 
                          ...
                          child: isMaintainedByUser == true 
                              ? Icon(Icons.check, size: 14, color: 
primaryColor) 
                              : null, 
                        ), 
                        SizedBox(width: 12), 
          ...
          Row( 
            children: [ 
              Container( 
                ...
                child: Icon(Icons.home_outlined, color: Colors.white, size: 
24), 
              ), 
              SizedBox(width: 16), 
              Expanded( 
              ...
              Container( 
                ...
                child: Column( 
                  ...
                  children: [ 
                    ...
                    SizedBox(height: 16), 
                    for (int j = 0; j < monthlyCtrls[selectedMonth].length; 
j++) 
                      Padding( 
