...
class _LoginPageState extends State<LoginPage> with TickerProviderStateMixin {
  ...
  void dispose() {
    ...
    usernameCtrl.dispose(); // Added to clean up controllers
    passwordCtrl.dispose(); // Added to clean up controllers
    super.dispose();
  }
  ...
  void _handleLogin() async {
    ...
    try {
      await AuthService.login(usernameCtrl.text, passwordCtrl.text);
      if (mounted) {
                    ...
                    child: FadeTransition(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 8),
                          const Text(
                            "Please log in to continue your tax calculations",
                            style: TextStyle(
                              fontSize: 16,
